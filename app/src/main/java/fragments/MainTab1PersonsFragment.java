 ...
 */
public class MainTab1PersonsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        btn_main_new.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = null;
                intent = new Intent(rootView.getContext(),PersonDefineActivity.class);
    ...
    private void createPersonList(View view) {
        ...
        PersonListAdapter adapter = new PersonListAdapter(view.getContext(),dbHelper.GetAllPersons(),false,new ArrayList<Integer>());
